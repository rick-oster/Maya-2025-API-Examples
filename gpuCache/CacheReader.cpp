...
public:
    ...
    public:
              ...
              fType(kHierarchyWorkItem)
        {
            ...
            fTask = BGReadHierarchyTask(scheduler, entry, proxy, geometryPath);
        }
              ...
              fType(kShapeWorkItem)
        {
            ...
            fTask = BGReadShapeTask(scheduler, entry, proxy, prefix, geometryPath);
        }
