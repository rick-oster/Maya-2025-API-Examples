...
// The selection works in a volume bounded by (-50000000..50000000) in all
// axes. Should the section need to work outside this volume, either of the
// these workarounds can be an option to get around the problem:
// 1. Toggle on Automatic camera-based selection or Camera-based selection 
//    in Selection Preferences. 
// 2. Set the environment variable MAYA_VP2_LOCALE_GRID_SIZE to a larger
//    value, e.g. twice the value of the scene bounding box.
